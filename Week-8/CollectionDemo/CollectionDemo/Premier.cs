...
namespace Lab26_Gui
{
    class Premier
    {
        ...
        public static List<Premier> GetPremiers()
        {
            ...
            premiers.Add(new Premier("Kathleen Wynne", "(b. 1953)", "MPP for Don Valley West", "11 February 2013", "October 2018", "Liberal Party Named leader in 2013"));
            premiers.Add(new Premier("Doug Ford", "(b. 1953)", "Etobicoke West", "11 February 2013", "Present", "Conservative"));
