...
namespace PictureBoxDemo
{
    class Premier
    {
        ...
        public static List<Premier> GetPremiers()
        {
            ...
            premiers.Add(new Premier("Kathleen Wynne", "(b. 1953)", "MPP for Don Valley West", "11 February 2013", "June 2018", "Liberal Party Named leader in 2013"));
            premiers.Add(new Premier("Doug Ford", "(b. 1964)", "MPP for Etobicoke North", "29 Juner 2018", "Present", "Progressive Conservative Party Named leader in 2018"));
